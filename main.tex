...
\begin{document}
	...
	\emptychapter{Messprotokoll}{3} % Usage: \emptychapter{name of the chapter}{page displayed in toc}
	...
	% BibTeX
	\TheBibliography
	\chapter*{\bibname} \addcontentsline{toc}{chapter}{\bibname} % \bibname = Bibliography oder Literaturverzeichnis
	\begingroup \newcommand{\relaxxx}[2]{} \let\chapter\relaxxx % in order to avoid the definition of an extra chapter
